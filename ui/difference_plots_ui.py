...
# Form implementation generated from reading ui file 'difference_plots.ui'
#
...
class Ui_Form_difference(object):
    def setupUi(self, Form_difference):
        Form_difference.setObjectName(_fromUtf8("Form_difference"))
        Form_difference.setEnabled(True)
        Form_difference.resize(680, 707)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Form_difference.sizePolicy().hasHeightForWidth())
        Form_difference.setSizePolicy(sizePolicy)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("../horsey8.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Form_difference.setWindowIcon(icon)
        self.centralwidget = QtGui.QWidget(Form_difference)
        ...
        self.label_frequency.setText(_fromUtf8(""))
        ...
        self.gridLayout.addLayout(self.gridLayout_12, 4, 0, 1, 1)
        ...
        self.gridLayout.addLayout(self.gridLayout_14, 3, 0, 1, 1)
        self.gridLayout_5 = QtGui.QGridLayout()
        self.gridLayout_5.setObjectName(_fromUtf8("gridLayout_5"))
        self.comboBox = QtGui.QComboBox(self.centralwidget)
        self.comboBox.setObjectName(_fromUtf8("comboBox"))
        self.gridLayout_5.addWidget(self.comboBox, 0, 0, 1, 1)
        self.pushButtonSwap = QtGui.QPushButton(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButtonSwap.sizePolicy().hasHeightForWidth())
        self.pushButtonSwap.setSizePolicy(sizePolicy)
        self.pushButtonSwap.setObjectName(_fromUtf8("pushButtonSwap"))
        self.gridLayout_5.addWidget(self.pushButtonSwap, 0, 1, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_5.addItem(spacerItem1, 0, 2, 1, 1)
        self.gridLayout.addLayout(self.gridLayout_5, 0, 0, 1, 1)
        Form_difference.setCentralWidget(self.centralwidget)
        self.menubar = QtGui.QMenuBar(Form_difference)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 680, 21))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        Form_difference.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(Form_difference)
        self.statusbar.setObjectName(_fromUtf8("statusbar"))
        Form_difference.setStatusBar(self.statusbar)

        self.retranslateUi(Form_difference)
        QtCore.QMetaObject.connectSlotsByName(Form_difference)

    def retranslateUi(self, Form_difference):
        Form_difference.setWindowTitle(_translate("Form_difference", "Difference Plots", None))
        self.groupBox_comments.setTitle(_translate("Form_difference", "Comments ", None))
        self.groupBox_test.setTitle(_translate("Form_difference", "Test Number ", None))
        self.groupBox_channel.setTitle(_translate("Form_difference", "Channel Number ", None))
        self.groupBoxUnits.setTitle(_translate("Form_difference", "Unit Type ", None))
        self.radioButtonMeanSpikes.setText(_translate("Form_difference", "Mean Spikes Per Presentation", None))
        self.radioButtonResponseRate.setText(_translate("Form_difference", "Response Rate (Hz)", None))
        self.groupBoxWindow.setTitle(_translate("Form_difference", "Use Custom Window ", None))
        self.label_xmax.setText(_translate("Form_difference", "X Max", None))
        self.doubleSpinBox_xmax.setSuffix(_translate("Form_difference", " s", None))
        self.doubleSpinBox_xmin.setSuffix(_translate("Form_difference", " s", None))
        self.label_xmin.setText(_translate("Form_difference", "X Min", None))
        self.label_ymax.setText(_translate("Form_difference", "Y Max", None))
        self.doubleSpinBox_ymax.setSuffix(_translate("Form_difference", " V", None))
        self.doubleSpinBox_ymin.setSuffix(_translate("Form_difference", " V", None))
        self.label_ymin.setText(_translate("Form_difference", "Y Min", None))
        self.pushButtonGenerate.setText(_translate("Form_difference", "Generate Plot", None))
        self.groupBoxThreshold.setTitle(_translate("Form_difference", "Threshold ", None))
        self.doubleSpinBox_threshold.setSuffix(_translate("Form_difference", " V", None))
        self.pushButton_auto_threshold.setText(_translate("Form_difference", "Estimate Threshold", None))
        self.groupBox_stimulus.setTitle(_translate("Form_difference", "Stimulus ", None))
        self.label_stim_type.setText(_translate("Form_difference", "None", None))
        self.groupBox_log.setTitle(_translate("Form_difference", "Log ", None))
        self.label.setText(_translate("Form_difference", "Open:", None))
        self.pushButton_browse.setText(_translate("Form_difference", "Browse...", None))
        self.groupBox_view.setTitle(_translate("Form_difference", "Trace View ", None))
        self.pushButtonSwap.setText(_translate("Form_difference", "Swap", None))
